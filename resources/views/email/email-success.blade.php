          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:25px;padding-right:0px;padding-bottom:20px;padding-left:0px;word-break:break-word;">
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                  <tbody>
                    <tr>
                      <td style="border-bottom:3px dashed #eee;vertical-align:top;padding-bottom:30px;">
                          ...
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                <tr>
                                  <td>Nama</td>
                                  <td style="text-align: right;"><strong>{{ $data->details[0]->name}}</strong></td>
                                </tr>
                                <tr>
                                  <td>Nomor Telepon</td>
                                  <td style="text-align: right;"><strong>{{ $data->details[0]->phone_number}}</strong></td>
                                </tr>
                                <tr>
                                  <td>Paket Pernikahan</td>
                                  <td style="text-align: right;"><strong>{{ $data->wedding_package->title }}</strong></td>
                                </tr>
                                <tr>
                                  <td>Tanggal Pernikahan</td>
                                  <td style="text-align: right;"><strong>{{ $data->details[0]->wedding_date }}</strong></td>
                                </tr>
                              </table>
                            </td>
                          </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:#888b93;">2020 Copyright • All Rights Reserved • Gendhis Wedding</div>
                    </td>
                  </tr>
                </table>
              </div>
